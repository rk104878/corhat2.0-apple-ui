...
const HeroSection = () => {
  return (
    <section className="w-full min-h-screen bg-white flex items-center justify-center px-6 md:px-16">
      
      <div className="max-w-6xl w-full grid md:grid-cols-2 gap-10 items-center">

        {/* LEFT SIDE */}
        <div>
          <p className="text-blue-600 tracking-widest text-sm font-semibold">
            THE CHALLENGE
          </p>

          <h1 className="text-3xl md:text-5xl font-bold leading-tight mt-3 text-gray-900">
          ...
          <div className="mt-6 space-y-4">
            <div>
              <h4 className="font-semibold text-gray-800">Skill Mismatch</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-800">Career Awareness</h4>
              <p className="text-gray-500 text-sm">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-gray-100 p-5 rounded-xl shadow-sm">
              ...
              <h2 className="text-3xl font-bold text-blue-600 mt-2">23.2%</h2>
              <p className="text-xs text-red-500 mt-1">+2.1% YoY</p>
            </div>

            <div className="bg-gray-100 p-5 rounded-xl shadow-sm">
              <p className="text-sm text-gray-500">Skills Gap</p>
              <h2 className="text-3xl font-bold text-blue-600 mt-2">75%</h2>
          ...
          {/* BIG BLUE CARD */}
          <div className="mt-6 bg-blue-600 text-white p-6 rounded-xl shadow-lg">
            <p className="text-sm opacity-80">Our Collective Impact</p>
            <h2 className="text-4xl font-bold mt-2">50,000+</h2>
            <p className="text-sm mt-1">Students empowered across 5 states</p>
          </div>
